<template>
  <div class="popular-flavors-section relative container">
    <div
      class="background-layer absolute w-full h-[70%] top-[5%] bg-palette2-4"
    ></div>
    <section
      class="container py-[30px] md:py-[64px] text-center overflow-hidden"
    >
...
const flavors = [
  ...
  },
  {
    ...
    subtitle: "Scented Candle",
    price: 82.0,
    imageSrc: "/src/assets/imgs/cards/6.avif",
  },
  {
    id: 6,
    title: "Bergamot",
    subtitle: "Scented Candle",
    price: 65.0,
    imageSrc: "/src/assets/imgs/cards/10.avif",
  },
];
